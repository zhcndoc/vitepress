import{_ as i,c as a,o as n,ah as l}from"./chunks/framework.BleJMeeG.js";const g=JSON.parse('{"title":"사이드바","description":"","frontmatter":{},"headers":[],"relativePath":"ko/reference/default-theme-sidebar.md","filePath":"ko/reference/default-theme-sidebar.md","lastUpdated":1743861572000}'),p={name:"ko/reference/default-theme-sidebar.md"};function h(k,s,t,e,E,d){return n(),a("div",null,s[0]||(s[0]=[l(`<h1 id="sidebar" tabindex="-1">사이드바 <a class="header-anchor" href="#sidebar" aria-label="Permalink to “사이드바”">​</a></h1><p>사이드바는 문서의 기본 탐색 블록입니다. <a href="./default-theme-config#sidebar"><code>themeConfig.sidebar</code></a>에서 사이드바 메뉴를 구성할 수 있습니다.</p><div class="language-js"><button title="Copy code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">export</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> default</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
